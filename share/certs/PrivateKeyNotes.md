...
unlocked to sign the BWS Coin-Qt.app bundle.
...
allowing somebody to distribute a BWS Coin-Qt.app or bwscoin-qt-setup.exe with a valid
...
that the bwscoin-qt.exe file inside the installer had not been tampered with.
