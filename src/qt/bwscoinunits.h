...
#ifndef BWSCOIN_QT_BWSCOINUNITS_H
#define BWSCOIN_QT_BWSCOINUNITS_H
...
/** BWS Coin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BWScoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BWScoinUnits(QObject *parent);
...
typedef BWScoinUnits::Unit BWScoinUnit;

#endif // BWSCOIN_QT_BWSCOINUNITS_H
