...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version")) {
        ...
        if (!gArgs.IsArgSet("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" + "  bwscoin-block-generator <number of blocks>  " + strprintf(_("Generates the specified number of blocks")) + "\n";
            strUsage += "\n";
        }
                    ...
                    if (!error.isNull()) {
                        ...
                        if (error.isObject())
                        {
                            ...
                            if (errCode.isNum() && errCode.get_int() == ToUnderlying(RPCErrorCode::WALLET_NOT_SPECIFIED)) {
                                strPrint += "\nTry adding \"-rpcwallet=<filename>\" option to bwscoin-block-generator command line.";
                            }
                        }
                    } else {
                        // Result
