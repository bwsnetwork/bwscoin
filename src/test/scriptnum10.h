...
#ifndef BWSCOIN_TEST_SCRIPTNUM10_H
#define BWSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BWS Coin Core 0.10.0, for cross-comparison.
 */
public:
