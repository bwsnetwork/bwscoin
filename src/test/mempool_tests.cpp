...
BOOST_AUTO_TEST_CASE(MempoolPersistenceTest)
{
    ...
    Coin coin1(CTxOut(contribution1, scriptPubKey1), 0, false, TX_Regular, MLTX_Regular, AT_COUNT);
    Coin coin2(CTxOut(contribution2, scriptPubKey2), 0, false, TX_Regular, MLTX_Regular, AT_COUNT);
...
BOOST_AUTO_TEST_CASE(MempoolMalleabilityTest)
{
    ...
    Coin coin1(CTxOut(contribution, scriptPubKey), 0, false, TX_Regular, MLTX_Regular, AT_COUNT);
