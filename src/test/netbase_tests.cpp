...
{
    BOOST_CHECK(TestSplitHost("www.bwscoin.org", "www.bwscoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bwscoin.org]", "www.bwscoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.bwscoin.org:80", "www.bwscoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bwscoin.org]:80", "www.bwscoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8567", "127.0.0.1", 8567));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8567", "127.0.0.1", 8567));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8567", "::ffff:127.0.0.1", 8567));
    BOOST_CHECK(TestSplitHost("[::]:8567", "::", 8567));
    BOOST_CHECK(TestSplitHost("::8567", "::8567", -1));
    BOOST_CHECK(TestSplitHost(":8567", "", 8567));
    BOOST_CHECK(TestSplitHost("[]:8567", "", 8567));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8567", "127.0.0.1:8567"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8567", "[::]:8567"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
