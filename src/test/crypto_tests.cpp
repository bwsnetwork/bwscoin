...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As BWS Coin relies on 80 byte header hashes, we want to have an example for that.",
               "6904772c15c731feca042fa7dd65d90113a32a11c9905f149c956be1589b54c2");
