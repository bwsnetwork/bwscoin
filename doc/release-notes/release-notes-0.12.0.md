...
Then, to tunnel a SSL connection on 28566 to a RPC server bound on localhost on port 18566 do:

    stunnel -d 28566 -r 127.0.0.1:18566 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:8566/
        ProxyPassReverse http://127.0.0.1:8566/
...
- #7209 `f3ad812` test: don't override BWSCOIND and BWSCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add BWSCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
