...
class WalletTest(BWScoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BWS from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 3000 BWS in block rewards plus fees, but
        ...
        # Send 10 BWS with subtract fee from amount
        ...
        # Sendmany 10 BWS with subtract fee from amount
