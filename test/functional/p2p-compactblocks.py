...
# TestNode: A peer we use to send messages to bwscoind, and store responses.
...
class CompactBlocksTest(BWScoinTestFramework):
    ...
    # This test actually causes bwscoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bwscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bwscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bwscoind will not send blocktxn responses for blocks whose height is
