...
class BIP66Test(BWScoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bwscoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bwscoind produces more specific reject
            # reasons.
