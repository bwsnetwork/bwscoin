...
class DisableWalletTest (BWScoinTestFramework):
    ...
    def run_test (self):
        ...
        x = self.nodes[0].validateaddress('Mb81nbBtd22MHwfFzjpEDaT3rQ5prnX6r6')
        assert(x['isvalid'] == True)

        # Checking mining to an address without a wallet. Generating to a valid address should succeed
        # but generating to an invalid address will fail.
        self.nodes[0].generatetoaddress(1, 'Mb81nbBtd22MHwfFzjpEDaT3rQ5prnX6r6')
