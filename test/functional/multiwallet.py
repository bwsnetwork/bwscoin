...
Verify that a bwscoind node can load multiple wallet files
"""
import os
import shutil
...
class MultiWalletTest(BWScoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w1_info['immature_balance'], 1500)
        ...
        w1.generate(101)
        assert_equal(w1.getbalance(), 3000)
